...
public class RestaurantService {
    ...
    public List<RestaurantDto> getRestaurants() {
        ...
        for (MenuItemEntity menuItemEntity : menuItemEntities) {
            // computeIfAbsent(): Check if there is a list for the restaurantId. If not, create an empty list.
            ...
            group.add(menuItemDto); // Add DTO to the map. group: the list retrieved from the map (computeIfAbsent())
        }
